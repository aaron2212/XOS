...
_kernel:
	...
	@$(CC) $(CFLAGS) kernel/system/syscalls/syscalls.c	-o objs/syscalls.o
	@$(CC) $(CFLAGS) kernel/system/syscalls/sys_exit.c		-o objs/sys_exit.o
	@$(CC) $(CFLAGS) kernel/system/syscalls/sys_fork.c		-o objs/sys_fork.o
	@$(CC) $(CFLAGS) kernel/system/syscalls/sys_read.c		-o objs/sys_read.o
	@$(CC) $(CFLAGS) kernel/system/syscalls/sys_open.c		-o objs/sys_open.o
	@$(CC) $(CFLAGS) kernel/system/syscalls/sys_close.c		-o objs/sys_close.o

	@$(CC) $(CFLAGS) kernel/system/syscalls/sys_creat.c		-o objs/sys_creat.o
	@$(CC) $(CFLAGS) kernel/system/syscalls/sys_execve.c		-o objs/sys_execve.o
	@$(CC) $(CFLAGS) kernel/system/syscalls/sys_chdir.c		-o objs/sys_chdir.o
	@$(CC) $(CFLAGS) kernel/system/syscalls/sys_time.c		-o objs/sys_time.o
	@$(CC) $(CFLAGS) kernel/system/syscalls/sys_getpid.c		-o objs/sys_getpid.o
	@$(CC) $(CFLAGS) kernel/system/syscalls/sys_getuid.c		-o objs/sys_getuid.o
