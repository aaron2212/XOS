...
/*
    Constants: shell constants
        BUF_SIZE     = 1024 - the maximum buffer size for the inputted string
        TOK_BUF_SIZE = 1024 - the maximum buffer size for the tokens
        TOK_DELIM    = " \t\r\n\a" - the delimiters to use to split the input string (excluding the double quotes)
*/
